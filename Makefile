...
ACLOCAL = ${SHELL} /tmp/buildd/manokwari-0.2.1.77/missing aclocal-1.15
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /tmp/buildd/manokwari-0.2.1.77/missing autoconf
AUTOHEADER = ${SHELL} /tmp/buildd/manokwari-0.2.1.77/missing autoheader
AUTOMAKE = ${SHELL} /tmp/buildd/manokwari-0.2.1.77/missing automake-1.15
AWK = mawk
BIN_PATH = 
CATALOGS = 
CATOBJEXT = .gmo
...
USE_NLS = yes
VALAC = /usr/bin/valac
VALA_PACKAGES = --pkg atk --pkg gdk-x11-3.0 --pkg gee-1.0 --pkg cairo --pkg gtk+-3.0 --pkg gio-unix-2.0 --pkg libgnome-menu-3.0 --pkg gdk-3.0 --pkg libwnck-3.0 --pkg unique-3.0 --pkg webkit-1.0 --pkg javascriptcore --pkg libsoup-2.4
VERSION = 0.1.0
WNCK_GMENU_DISCLAIMER = -DGMENU_I_KNOW_THIS_IS_UNSTABLE -DWNCK_I_KNOW_THIS_IS_UNSTABLE
XGETTEXT = /usr/bin/xgettext
XSESSIONS_PATH = 
abs_builddir = /tmp/buildd/manokwari-0.2.1.77/system
abs_srcdir = /tmp/buildd/manokwari-0.2.1.77/system
abs_top_builddir = /tmp/buildd/manokwari-0.2.1.77
abs_top_srcdir = /tmp/buildd/manokwari-0.2.1.77
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /tmp/buildd/manokwari-0.2.1.77/install-sh
